...
readonly SCRIPTNAME="train_transferLearning_dom1.py"
...
readonly HP_NAME='tl_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_ME_MG_Z0_01_domaine2_transfer_learning_Final_HP_Search' #'Js_WindVV_DeepSD_l_ssim_m_mean_absolut_test1' #Always change this path.  #Js_Wind_FSRCNN_l_mean_absolut_m_ssim_test1
...
readonly LEARNING_RATE_HP=(0.00001)
