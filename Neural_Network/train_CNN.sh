...
readonly SCRIPTNAME="train_CNN.py"
...
readonly HP_NAME='NoInterpol_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_ME_MG_Z0_000000000002_Final_article_writting' #Final_search
...
readonly LEARNING_RATE_HP=(0.001) # 0.01 0.001 0.0001 0.00001
