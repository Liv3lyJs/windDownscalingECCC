...
def path_creation(INPUT_FILE, LABEL_FILE, TOPO_FILE, PATH_RESULTS, HP_NAME, DATA_ALREADY_SPLIT):
    ...
    HP_RESULT_PATH = f"{PATH_RESULTS}/non_interpolation_cad_10_{var_name}/{HP_NAME}_HP_Search" 
    HP_DIR = f"{HP_NAME}_{var_name}_hp_search"

    if DATA_ALREADY_SPLIT:
        #Input file
        PATH_INPUT_TRAIN = '/home/jfg000/ss5/data_superResolution/input/domaine/non_interpolation/data_used_in_neural_network_cad_10/east_canada_squential_train_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'    #/home/jfg000/ss5/Data/input/domaine/east_canada_test_sequential_train/UU_VV_TT_P0_PN_H_CX_SD_WGE_data
        PATH_INPUT_VALID = '/home/jfg000/ss5/data_superResolution/input/domaine/non_interpolation/data_used_in_neural_network_cad_10/east_canada_squential_valid_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_INPUT_TEST = '/home/jfg000/ss5/data_superResolution/input/domaine/non_interpolation/data_used_in_neural_network_cad_10/east_canada_squential_test_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        ...
        #label file
        PATH_LABEL_TRAIN = '/home/jfg000/ss5/data_superResolution/label/domaine/non_interpolation/data_used_in_neural_network_cad_10/east_canada_squential_train_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_LABEL_VALID = '/home/jfg000/ss5/data_superResolution/label/domaine/non_interpolation/data_used_in_neural_network_cad_10/east_canada_squential_valid_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_LABEL_TEST = '/home/jfg000/ss5/data_superResolution/label/domaine/non_interpolation/data_used_in_neural_network_cad_10/east_canada_squential_test_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        ...
        PATH_SKIP_TRAIN = '/home/jfg000/ss5/data_superResolution/input/domaine/non_interpolation/data_used_in_neural_network_cad_10/east_canada_squential_train_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_SKIP_VALID = '/home/jfg000/ss5/data_superResolution/input/domaine/non_interpolation/data_used_in_neural_network_cad_10/east_canada_squential_valid_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_SKIP_TEST =  '/home/jfg000/ss5/data_superResolution/input/domaine/non_interpolation/data_used_in_neural_network_cad_10/east_canada_squential_test_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        ...
        #Topo file
        PATH_TOPO = '/home/jfg000/ss5/data_superResolution/topography/non_interpolation/data_used_in_neural_network_cad_10/east_canada_squential_train_allpasses_domaine/ME_MG_Z0_data'
...
def dataProcessing_already_split(inputs_train, inputs_valid, inputs_test, labels_train, label_valid, label_test, skip_train, skip_valid, skip_test, topo_train):
    ...
    #     plt.imshow(top[:,:,2])
    #     plt.show() 
    topo_val_reshaped = np.tile(topo, (int(inputs_valid.shape[0] / 10), 1, 1, 1))
    # for top in topo_val_reshaped:
    #     plt.imshow(top[:,:,2])
    #     plt.show() 
    topo_test_reshaped = np.tile(topo, (int(inputs_test.shape[0] / 10), 1, 1, 1))
...
def tuner_initialization(hyper_parameters_search, NUM_TRIALS, EXECUTIONS_PER_TRIAL, directory, HP_DIR):
    ...
    tuner = BayesianOptimization(                            # RandomSearch
        ...
        project_name='NoInterpol_10dom_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_ME_MG_Z0_000000000001_hp_search_Final_notUV' #HP_DIR
    )
...
def hyper_parameters_search(hp):
    ...
    drop_rate = hp.Choice('drop_rate', values=[0.35]) #, 0.05, 0.10, 0.15, 0.2     0.10, 0.20, 0.30, 0.40, 0.50
    ...
    model = mod.deepRU_article_non_interpolation_combine_loss_notUV(units, activation, lr, kernel_size, kernel_size_e1, kernel_size_e2, kernel_size_e3, kernel_size_d1, kernel_size_d2, kernel_size_d3,
...
if __name__ == '__main__':
    ...
    train_dataset = tf.data.Dataset.from_generator(
        ...
        output_signature=(
            (tf.TensorSpec(shape=(None, 16, 16, 26), dtype=tf.float32),
    ...
    print(f'Memory used after tf.data.Dataset.from_generator ')
    print_memory_usage()
    ...
    for j, hyp in enumerate(best_hp, start=1):
        ...
        model = mod.deepRU_article_non_interpolation_combine_loss_notUV(units=hyp.get("units"), activation=hyp.get("activation"), lr=hyp.get("lr"), kernel_size=hyp.get("kernel_size"), kernel_size_e1=hyp.get("kernel_size_e1"), kernel_size_e2=hyp.get("kernel_size_e2"),  kernel_size_e3=hyp.get("kernel_size_e3"),
