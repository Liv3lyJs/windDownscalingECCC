...
readonly SCRIPTNAME="train_CNN_cad_10.py"
...
readonly HP_NAME='NoInterpol_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_ME_MG_Z0_000000000001_Final_notUV' #'Js_WindVV_DeepSD_l_ssim_m_mean_absolut_test1' #Always change this path.  #Js_Wind_FSRCNN_l_mean_absolut_m_ssim_test1
