...
def path_creation(INPUT_FILE, LABEL_FILE, TOPO_FILE, PATH_RESULTS, HP_NAME, DATA_ALREADY_SPLIT):
    ...
    HP_RESULT_PATH = f"{PATH_RESULTS}/bilinear_interpolation_qcnb_{var_name}/{HP_NAME}_HP_Search" 
    HP_DIR = f"{HP_NAME}_{var_name}_hp_search"

    if DATA_ALREADY_SPLIT:
        #Input file
        PATH_INPUT_TRAIN = '/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_train_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_INPUT_VALID = '/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_valid_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_INPUT_TEST = '/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_test_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        ...
        #label file
        PATH_LABEL_TRAIN = '/home/jfg000/ss5/data_superResolution/label/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_train_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_LABEL_VALID = '/home/jfg000/ss5/data_superResolution/label/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_valid_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_LABEL_TEST = '/home/jfg000/ss5/data_superResolution/label/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_test_allpasses_domaine/UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        ...
        PATH_SKIP_TRAIN = '/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_train_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_SKIP_VALID = '/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_valid_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        PATH_SKIP_TEST =  '/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_test_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data'
        ...
        #Topo file
        PATH_TOPO = '/home/jfg000/ss5/data_superResolution/topography/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_train_allpasses_domaine/ME_MG_Z0_data'
...
def load_data_already_split(INPUT_FILE_TRAIN, INPUT_FILE_VALID, INPUT_FILE_TEST, LABEL_FILE_TRAIN, LABEL_FILE_VALID, LABEL_FILE_TEST, SKIP_FILE_TRAIN, SKIP_FILE_VALID, SKIP_FILE_TEST, TOPO_FILE):
    ...
    # topo_train_reshaped = np.tile(topo, (int(inputs_train.shape[0] / 10), 1, 1, 1))
...
def tuner_initialization(hyper_parameters_search, NUM_TRIALS, EXECUTIONS_PER_TRIAL, directory, HP_DIR):
    ...
    tuner = BayesianOptimization(                            # RandomSearch
        ...
        project_name='bilinear_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_ME_MG_Z0_000000000001_hp_search_Final_search' #HP_DIR
    )
...
def hyper_parameters_search(hp):
    ...
    load_model = False
    if load_model:
        model.load_weights(f"/home/jfg000/ss5/CNN_results/non_interpolation_UU/nearest_neighboor_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_ME_MG_Z0_00000006_HP_Search/model/Searchmodel_1")
...
def de_standardize(test_data_input, predictions, test_data_label, skip_test_data):
    std_inputs = np.load('/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_train_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data/std.npy')
    mean_inputs = np.load('/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_train_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data/mean.npy') 
    std_label = np.load('/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_train_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data/std.npy')
    mean_label = np.load('/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_train_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data/mean.npy') 
    std_skip = np.load('/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_train_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data/std.npy')
    mean_skip = np.load('/home/jfg000/ss5/data_superResolution/input/domaine/bilinear_interpolation/data_used_in_neural_network_qcnb/east_canada_squential_train_allpasses_domaine/skip_connection_UV_UU_VV_TT_P0_PN_H_CX_SD_WGE_data/mean.npy')
